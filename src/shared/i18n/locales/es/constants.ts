export default {
  ...
  dashscopeDesc: "Modelos Qwen mediante DashScope",
  dashscopeEndpoint: "Endpoint de DashScope",
  dashscopeChinaEndpoint: "China continental",
  dashscopeIntlEndpoint: "Internacional",
  dashscopeApiKey: "Clave API de Alibaba DashScope",
  dashscopeHint: "Modelos Qwen vía DashScope / Model Studio",
