export default {
  ...
  messages: "Messages",
  memories: "Memories",
  providersTitle: "External memory providers",
  agentMemory: "Agent Memory",
  userProfile: "Memory of user",
  userProfileOf: "{{agent}}'s memory of you",
  ...
  providerBuiltIn: "None connected",
  vaultNotLinked: "No vault linked",
  ...
  providerDesc:
    "An external memory backend or notes vault, alongside built-in memory.",
