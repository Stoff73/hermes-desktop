export default {
  ...
  openaiCodexName: "Assinatura do ChatGPT",
  ...
  dashscopeDesc: "Modelos Qwen via DashScope",
  dashscopeEndpoint: "Endpoint do DashScope",
  dashscopeChinaEndpoint: "China continental",
  dashscopeIntlEndpoint: "Internacional",
  dashscopeApiKey: "Chave de API do Alibaba DashScope",
  dashscopeHint: "Modelos Qwen via DashScope / Model Studio",
